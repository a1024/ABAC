...
void			abac2_encode(const short *buffer, int imsize, int depth, std::string &out_data, int *out_sizes, int *out_conf, bool loud=false);
void			abac2_decode(const char *data, const int *sizes, const int *conf, short *buffer, int imsize, int depth, bool loud=false);
